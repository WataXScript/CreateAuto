...
local function showReplaySelectorSingle()
    ...
    print("Replay files ditemukan:", #files)
...
startCP.MouseButton1Click:Connect(showReplaySelectorSingle)
...
startAll.MouseButton1Click:Connect(showReplaySelectorMulti)
